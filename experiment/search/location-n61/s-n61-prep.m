...
Experiment.title = 'Fovea neglect effect for visual search in white noise -- Part 3 (n61)';
...
for S = 1:Experiment.nSessions
    for C = 1:Experiment.nConditions
        for L = 1:Experiment.nLevels
            Stimulus.targetAmplitude(S,C,L) = 5;
...
save(['p3_n61_Experiment_', Experiment.subject, '.mat'], 'Experiment');
save(['p3_n61_Stimulus_', Experiment.subject, '.mat'], 'Stimulus', '-v7.3');
...
save(['p3_n61_Results_', Experiment.subject, '.mat'], 'Results');