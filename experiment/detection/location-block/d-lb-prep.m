...
Experiment.title = 'Fovea neglect effect for visual search in white noise -- Part 2';
...
Experiment.nLevels = Stimulus.nLocations - 1;
...
save(['p2_Stimulus_', Experiment.subject, '.mat'], 'Stimulus', '-v7.3');
